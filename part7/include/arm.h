 ...
 * These are indeces of registers stored in a PCB.
 */
...
#define PREG_R10	10
#define PREG_R11	11
#define PREG_IP		12		/* Intra-procedural scratch register (ip) - USED TO SWITCH REGISTERS		*/
#define PREG_SP		13		/* Stack pointer (sp) - Ex: mov sp, #4					*/
#define PREG_LR		14		/* Link register (lr) - When program is done running, lr tells you where to return to 							*/
#define PREG_PC		15		/* Program counter (pc)	- store the address of the next instruction.
                                //Store and load something else				*/

#define PREGS		16		/* Regs stored by context switches			*/

                            // May overwrite what a parameter is -> DONT OVERWRITE
#endif /* _ARM_H_ */
