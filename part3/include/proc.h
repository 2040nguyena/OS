...
#define NPROC       50        /**< set the number of processes     NEED THIS     */
#endif
...
#define PRFREE      0       /**< process slot is free           NEED THIS         */
#define PRCURR      1       /**< process is currently running   NEED THIS         */
#define PRSUSP      2       /**< process is suspended           NEED THIS         */
#define PRREADY     3       /**< process is on ready queue      NEED THIS        */

// Go from PRFREE to PRSUSP: use create()
// GO from PRSUSP to PRREADY: use ready()
// Go from PRREADY to PRCURR and back to PRREADY: resched()
// Go back to PRFREE: use kill()

/* miscellaneous process definitions                                     */

#define PNMLEN      16      /**< length of process "name"       NEED THIS         */
...
{
    ulong priority;             /**<priority of the process                */
    int state;                  /**< process state: PRCURR, etc.             */
    void *stkbase;              /**< base of run time stack                  */
    int stklen;                 /**< stack length                            */
	int core_affinity;          /**< core affinity (what core it is running on)                          */
