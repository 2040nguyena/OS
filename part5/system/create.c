...
// create.c: change atomic increment 
// create.c: use getmem instead of getstk
// getmem(), freemem()
// after done with getmem() and freemem(), do malloc() and free()
// after done with each function, implement them in testcase.c
#include <arm.h>
#include <xinu.h>
